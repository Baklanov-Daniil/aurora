...
static QObject *recognizerSingleton(QQmlEngine *, QJSEngine *)
{
    ...
    r->setModelPath("/usr/share/ru.omstu.goloslov/models/vosk-model-small-ru-0.22");    
    r->init();
    return r;
}
...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterSingletonType<SpeechRecognizer>("ru.omstu.goloslov", 1, 0, "SpeechRecognizer", recognizerSingleton);
